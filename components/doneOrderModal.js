...
export default function DoneOrderModal({ button, className, order }) {
        ...
        >
          ...
          >
            <h2 className="sm:text-xl text-lg font-semibold mb-2">
             Are you sure you setup the order of <span className="text-blue-500">{order.name}</span>
            </h2>
            ...
            <div className="mt-4 flex justify-end">
              {isDeleting ? (
                ...
                <>
                  <button
                    className="px-4 py-2 bg-blue-500 rounded hover:bg-blue-600 mr-2"
                    type="submit"
                  >
                    Done
                  </button>
